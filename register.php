...
<?php
	...
	$errPwd="Enter information to login";
	$uppercase=$lowercase=$number=$specialchars=$errmail=$some="";
	if (isset($_POST['signup'])){
		...
		// 	$some= "";
		// $errPwd= 'Password is not Strong';
		// }
		// else{
		// 	$some= "";
		// $errPwd= "Password is Strong";
		// } 
		...
		if($errmail=="" && $errPwd=="Password is Strong")
		{//echo "bingo";
	...
	{
		$errPwd="Enter Emailid and Password to reg";
	}
?>
<?php
	//include "dbsignup.php";
											...
											<div class="row">
												<div class="col-sm-12">
													<div class="input-group mb-0">
														<input class="btn btn-primary btn-lg btn-block" type="submit" name="signup">
													</div>
