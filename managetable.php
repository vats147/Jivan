                                                    ...
                                                    <div class="pd-20 card-box mb-30">
                                                        ...
                                                        <form>
                                                            <div class="form-group row">
                                                                <label class="col-sm-12 col-md-2 col-form-label">TableName(Code):</label>
                                                                <div class="col-sm-12 col-md-10">
                                                                    <input class="form-control" type="text" placeholder="A15-A17" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-12 col-md-2 col-form-label">Branch Code</label>
                                                                <div class="col-sm-12 col-md-10">
                                                                    <input class="form-control" type="text" placeholder="102" disabled/>
                                                                </div>
                                                            </div>
											...
											<div class="pd-20">
												<table class="data-table table stripe hover nowrap">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="table-plus">1234  </td>
                                                            <td><a>Path image</a></td>
                                                            <!-- <td>Gemini</td>
                                                            <td>Gujarat</td>
                                                            <td>395010</td> -->
                                                            <td>
